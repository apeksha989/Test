        ...
        if leftViewController != nil {
            ...
            if SlideMenuOptions.tapGesturesEnabled {
                if leftTapGesture == nil {
                    leftTapGesture = UITapGestureRecognizer(target: self, action: #selector(self.toggleLeft1))
        ...
        if rightViewController != nil {
            ...
            if SlideMenuOptions.tapGesturesEnabled {
                if rightTapGesture == nil {
                    rightTapGesture = UITapGestureRecognizer(target: self, action: #selector(self.handleRightPanGesture(_:)))
...
//    }
    ...
    public func rightMinOrigin() -> CGFloat {
     ...
     func panRightResultInfoForVelocity(_ velocity: CGPoint) -> PanInfo {
    ...
    public func applyRightTranslation(_ translation: CGPoint, toFrame: CGRect) -> CGRect {
    ...
    public func getOpenedRightRatio() -> CGFloat {
    ...
    public func applyRightContentViewScale() {
        let openedRightRatio: CGFloat = getOpenedRightRatio()
    ...
    public func slideRightViewForGestureRecognizer(_ gesture: UIGestureRecognizer, withTouchPoint point: CGPoint) -> Bool {
        return isRightOpen() || SlideMenuOptions.rightPanFromBezel && isRightPointContainedWithinBezelRect(point)
    }
    
    public func isRightPointContainedWithinBezelRect(_ point: CGPoint) -> Bool {
    ...
    public func isPointContainedWithinRightRect(_ point: CGPoint) -> Bool {
...
//      let leftButton: UIBarButtonItem = UIBarButtonItem(image: buttonImage, style: UIBarButtonItem.Style.plain, target: self, action: #selector(self.toggleLeft1))
...
//        navigationItem.rightBarButtonItem = rightButton
    ...
    public func addPriorityToMenuGesuture(_ targetScrollView: UIScrollView) {
      guard let slideController = SlideMenuController() as? UIViewController, let recognizers = slideController.view.gestureRecognizers else {
            return
        }
